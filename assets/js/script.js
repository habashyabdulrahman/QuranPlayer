...
async function getReciters() {
    ...
    chooseReciter.innerHTML = `<option value="">أختر قارئ</option>`;
...
async function getMoshaf(reciter) {
    ...
    chooseMoshaf.innerHTML = `<option value="" data-server="" data-surahList="" >أختر رواية</option>`;
...
async function getSurah(surahServer, surahList) {
    ...
    chooseSurah.innerHTML = `<option value="">أختر سورة</option>`;
